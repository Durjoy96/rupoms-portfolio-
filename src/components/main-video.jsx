...
export default function MainVideo() {
  ...
  return (
    <>
      <GridLine />
      <div className="border max-w-2xl mx-auto z-30 flex flex-col justify-center min-h-[83vh] px-5 lg:px-0">
        <h2 className="text-3xl lg:text-5xl font-bold text-base-content z-10 text-center">
          Need Video Editing? Here’s What I Bring to the Table
        </h2>
        <div className="relative w-full mt-12 z-20">
          <div
            data-scroll
            data-scroll-speed="0.5"
            className="w-full h-[250px] md:h-[380px] rounded-xl"
          >
            {/* thumbnail */}
            <div
            ...
            >
              <Image
                src="https://img.youtube.com/vi/njKNhsUV6ic/maxresdefault.jpg"
                alt="must watch"
                width={200}
                height={100}
              ...
              <div className="bg-base-100 w-14 h-14 flex items-center justify-center rounded-full absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 transition-all delay-200 group-hover:scale-[1.2]">
                <Play className="w-6 h-6 stroke-[1.6px] stroke-primary fill-primary group-hover:stroke-primary transition-all delay-200 group-hover:scale-[1] group-hover:fill-primary" />
              </div>
            </div>
            {/* Video */}
            <iframe
              className={`w-full h-full rounded-xl ${!playVideo && "hidden"}`}
              src={`https://www.youtube.com/embed/njKNhsUV6ic?${
                playVideo && "autoplay=1"
              }`}
              title="Fiverr Video Editing Gig 2026 | Rupom Sarker"
              frameBorder="0"
          ...
          {/* side text */}
          <div className="hidden absolute -left-24 top-1/3 -translate-y-1/3 md:flex flex-col items-center gap-1">
