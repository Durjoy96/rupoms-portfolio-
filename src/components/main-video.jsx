...
export default function MainVideo() {
  ...
  return (
    <div className="relative max-w-2xl mx-auto z-10 min-h-[83vh] flex items-center">
      <div
        data-scroll
        data-scroll-speed="0.5"
        className="w-full h-[300px] md:h-[380px] rounded-xl"
      >
        {/* thumbnail */}
        <div
          className={`relative group cursor-pointer ${playVideo && "hidden"}`}
      ...
      <div className="hidden absolute -left-24 top-1/3 -translate-y-1/3 md:flex flex-col items-center gap-1">
        <p className="text-sm text-base-content-secondary">Must Watch</p>
        {/* arrow */}
        <svg
